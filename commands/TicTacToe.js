...
const stickers = [
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-1.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-2.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-3.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-3.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-4.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-4.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-5.webp",
 "https://raw.githubusercontent.com/254gerboo/tribal-chief-Md-Media/main/ᴅɪᴄᴇ/tribal-chief-ᴍᴅ-ᴅɪᴄᴇ-6.webp",
 ];
...
smd(
 ...
 async (tribalchief,msgs,text,{isCreator}) => {
       if (!msgs.isGroup) return msgs.reply(tlang().group);
       const groupMetadata = msgs.isGroup ? await tribalchief.bot.groupMetadata(msgs.chat).catch((e) => {}) : "";
       const participants = msgs.isGroup ? await groupMetadata.participants : "";
       const groupAdmins = await getAdmin(tribalchief.bot, msgs)
...
`;
       ...
       return await tribalchief.bot.sendMessage(msgs.chat, { text: str, mentions: [room.game.currentTurn], });
     } else {
       room = {
...
❌:- @${room.game.playerX.split("@")[0]}`;
     ...
     if(isWin && isMongodb){ await eco.give(msgs.sender, "tribalchief", 2000); }
     if (isWin || isTie) { 
       await tribalchief.bot.sendMessage(msgs.chat, { text: str, mentions: [room.game.playerO,room.game.playerX], });
       delete this.game[room.id];
     } 
     else {  await tribalchief.bot.sendMessage(msgs.chat, {  text: str,   mentions: [room.game.playerO,room.game.playerX], });  }
   }
 }
);

smd({ pattern: "ship" , category: "fun" }, async(tribalchief, msgs, text) => {
  ...
  const percentage = Math.floor(Math.random() * 100)
   async function couple(percent) {
      ...
      let caption = `\t❣️ *Matchmaking...* ❣️ \n`
       ...
       await tribalchief.bot.sendMessage(msgs.chat,{text: caption,mentions: [msgs.sender,shiper]},{quoted:msgs})
  }
)
