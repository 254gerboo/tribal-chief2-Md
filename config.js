...
global.gurl = 'https://youtube.com/c/254gerboo' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '254710537788'; ;
global.devs = "254710537788"; //Dont change it From here
global.github  = process.env.YOUR_GITHUB || 'https://github.com/254gerboo/tribal-chief-md';
global.scan  = process.env.QR_URL || 'https://replit.com/@254gerboo/tribal-chief-md?v=1';
global.website = 'https://github.com/254gerboo/tribal-chief-md' ; //wa.me/+254000000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/NpA3ZsJ.jpeg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'tribal-chief-md',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `It'x 254gerboo`,
  author:  process.env.PACK_AUTHER || '254gerboo',
  errorChat : process.env.ERROR_CHAT|| '', // put 'chat' here to send error in chat ,where it accures
  read_status : process.env.AUTO_READ_STATUS || 'false',
  save_status : process.env.AUTO_SAVE_STATUS || 'false',
  packname:  process.env.PACK_NAME || "\t   𓅋 gerboo 𓃮 \n\nᴋɪss ʍᴇ...💋\n\nᴄʟօsᴇ ყσυɾ ᴇყᴇs...👁️🙈\n\nʍɪss ʍᴇ...♥️\n\n\n   -ᴘʟᴇᴀsᴇ ᴅᴏɴ'ᴛ ᴛᴀӄᴇ 🚮 \n\n--- ρυвʟɪᴄ вσт нᴇʀᴇ ---" ,
  ...
  caption :process.env.CAPTION || "```ᴘᴏᴡᴇʀᴇᴅ ʙʏ tribal-chief-ᴍᴅ```",   //*
    OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.0.0.1',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'GERBOO',
